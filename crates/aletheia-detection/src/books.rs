...
pub const BOOKS: &[BookEntry] = &[
    ...
    BookEntry {
        ...
        aliases: &[
            ...
            "dutronomy",
            "deutoronomy",
            "deutronomy", // Nigerian Whisper phonetics
        ],
        max_chapter: 34,
    },
    // ---------- History ----------
    ...
    BookEntry {
        canonical: "Psalms",
        aliases: &["psalms", "psalm", "psa", "pss", "ps"],
        max_chapter: 150,
    },
    BookEntry {
        canonical: "Proverbs",
        aliases: &["proverbs", "prov", "prv", "pr"],
        max_chapter: 31,
    },
    BookEntry {
        canonical: "Ecclesiastes",
        aliases: &["ecclesiastes", "eccl", "ecc", "ec", "qoh"],
        max_chapter: 12,
    },
    BookEntry {
    ...
    BookEntry {
        canonical: "Isaiah",
        aliases: &[
            "isaiah", "isa", "is", "izaya", "ezaya", "isaya",
            "ezaia", // Nigerian/West African Whisper variants
        ],
        max_chapter: 66,
    },
    BookEntry {
    ...
    BookEntry {
        canonical: "Matthew",
        aliases: &[
            "matthew", "matt", "mat", "mt", "matius", "matiyu",
            "matu", // Nigerian Whisper phonetics
        ],
        max_chapter: 28,
    },
    BookEntry {
    ...
    BookEntry {
        canonical: "Acts",
        aliases: &["acts", "act", "ac", "acts of the apostles"],
        max_chapter: 28,
    },
    // ---------- Pauline Epistles ----------
    BookEntry {
    ...
    BookEntry {
        ...
        aliases: &[
            ...
            "ep",
            "efishans",
            "efesians", // Nigerian Whisper phonetics
        ],
        max_chapter: 6,
    },
    BookEntry {
        ...
        aliases: &[
            ...
            "filipians",
            "phillipians",
            "filipins", // Nigerian Whisper phonetics
        ],
        max_chapter: 4,
    },
    BookEntry {
    ...
    BookEntry {
        ...
        aliases: &[
            ...
            "apoc",
            "revelashan",
            "revelatian", // Nigerian Whisper phonetics
        ],
        max_chapter: 22,
    },
];
...
pub fn lookup_exact(alias_folded: &str) -> Option<&'static BookEntry> {
    for book in BOOKS {
        if book.aliases.iter().any(|a| *a == alias_folded) {
            return Some(book);
        }
    }
    None
...
pub fn longest_match_at<'a>(
    tokens: &'a [&str],
    start: usize,
) -> Option<(
    &'static BookEntry,
    usize,  /* tokens consumed */
    String, /* alias */
)> {
    if start >= tokens.len() {
        return None;
