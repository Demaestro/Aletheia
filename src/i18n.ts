...
const resources = {
  en: {
    ...
    common: {
      ...
      desktop: "Desktop",
      browser: "Browser",
      dataMiser: "Data miser",
      search: "Search",
      manualScriptureSearch: "Manual scripture search"
    },
    dashboard: {
    ...
    dashboardBible: {
      ...
      previewLive: "Preview and live output.",
      listenerManaged: "Always-on command listener is managed by the desktop core.",
      ...
      checkDiagnostics: "Check transcript diagnostics",
      speakOrNavigate: "Speak a scripture command or navigate manually.",
    ...
    output: {
      ...
      destinationsArmed: "Destinations armed",
      safeHold: "Safe hold",
      controls: "Output controls",
      stageDisplay: "Stage display",
      mirrorPreview: "Mirror preview",
      lowerThird: "Lower third",
      ndiUnavailable: "NDI not available",
      clearLive: "Clear live",
      removeScripture: "Remove scripture",
      blackOutput: "Black output",
      safetyBlackout: "Safety blackout",
      holdDestinations: "Hold destinations",
      armDestinations: "Arm destinations",
      sendPreviewLive: "Send preview live",
      armAndSend: "Arm and send live",
  ...
  ig: {
    ...
    common: {
      ...
      outputArmed: "Mmepụta akwadoro",
      outputHold: "Jide mmepụta",
      operatingMode: "Ụdị ọrụ",
      interfaceLanguage: "Asụsụ ihu ngwa",
      switchToLight: "Gbanwee gaa ọkụ",
      switchToDark: "Gbanwee gaa ọchịchịrị",
      light: "Ọkụ",
      dark: "Ọchịchịrị",
      desktop: "Desktọpụ",
      browser: "Ihe nchọgharị",
      dataMiser: "Chekwa data",
      search: "Chọọ",
      manualScriptureSearch: "Chọgharị Akwụkwọ Nsọ aka"
    },
    dashboard: {
    ...
    dashboardBible: {
      programMonitor: "Nlele mmemme",
      previewLive: "Nlele na mmepụta ndụ.",
      listenerManaged: "Isi desktọpụ na-achị onye na-ege iwu olu mgbe niile.",
      translation: "Nsụgharị Baịbụl",
      book: "Akwụkwọ Baịbụl",
      chapter: "Isi",
      verse: "Amaokwu",
      open: "Mepee",
      previousChapter: "Isi gara aga",
      nextChapter: "Isi ọzọ",
      checkDiagnostics: "Lelee nchọpụta transcript",
      speakOrNavigate: "Kwuo iwu Akwụkwọ Nsọ ma ọ bụ jiri aka gaa.",
      verseCount: "{{count}} amaokwu"
    },
    output: {
      eyebrow: "Mmepụta ngosi",
      title: "Nlele dị nchebe. Ndụ bụ iwu doro anya.",
      detail: "Ebe mmepụta na-edobe nlele na ndụ iche ka ndị ọrụ nwee ike nwalee n'enweghị mgbanwe projector ma ọ bụ stream.",
      destinationsArmed: "Ebe mmepụta akwadoro",
      safeHold: "Njide nchekwa",
      controls: "Njikwa mmepụta",
      stageDisplay: "Ihu ngosi stage",
      mirrorPreview: "Gosi nlele ọzọ",
      lowerThird: "Lower third",
      ndiUnavailable: "NDI adịghị",
      clearLive: "Hichapụ ndụ",
      removeScripture: "Wepụ Akwụkwọ Nsọ",
      blackOutput: "Mee mmepụta oji",
      safetyBlackout: "Blackout nchekwa",
      holdDestinations: "Jide ebe mmepụta",
      armDestinations: "Kwadebe ebe mmepụta",
      sendPreviewLive: "Zipu nlele ndụ",
      armAndSend: "Kwadebe ma zipu ndụ",
      destinationStatus: "Ọnọdụ ebe mmepụta"
    },
    health: {
